    ...
    <div class="page-wrapper">
        <div class="page-content">
            <div class="d-flex justify-content-between flex-column flex-md-row mb-3 mb-md-1">
                <div>
                    <!-- Top Welcome Content -->
                    <h4 class="font-weight-bold1">Welcome, {{ $user->name }} {{ $user->type }}</h4>
                        ...
                        <table class="table align-middle mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>Iphone 5</td>
                                    <td>
                                        <img src="{{ asset('admin/assets/images/products/01.png') }}"
                                ...
                                <tr>
                                    <td>Earphone GL</td>
                                    <td>
                                        <img src="{{ asset('admin/assets/images/products/02.png') }}"
                                            class="product-img-2" alt="product img" />
                                    </td>
                                    <td>#8304620</td>
                                    <td>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-xl-4">
                                    <div class="mb-4">
                                        <p class="mb-2">
                                            <i class="flag-icon flag-icon-us me-1"></i> USA
                                    ...
                                    <div class="mb-4">
                                        <p class="mb-2">
                                            <i class="flag-icon flag-icon-ca me-1"></i> Canada
                                    ...
                                    <div class="mb-4">
                                        <p class="mb-2">
                                            <i class="flag-icon flag-icon-gb me-1"></i> England
                                    ...
                                    <div class="mb-4">
                                        <p class="mb-2">
                                            <i class="flag-icon flag-icon-au me-1"></i> Australia
                                    ...
                                    <div class="mb-4">
                                        <p class="mb-2">
                                            <i class="flag-icon flag-icon-in me-1"></i> India
                                    ...
                                    <div class="mb-0">
                                        <p class="mb-2">
                                            <i class="flag-icon flag-icon-cn me-1"></i> China
